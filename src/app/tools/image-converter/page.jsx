...
//   return (
//     <MainLayout title="Image Converter" showBuyMeACoffee={true}>
//       <div className="mb-6">
//         <input
//           type="file"
//           accept="image/*"
...
//     const formData = new FormData();
//     // Append ALL selected files under the key 'images' (plural)
//     selectedFiles.forEach(file => {
//       formData.append('images', file);
//     });
//     formData.append('format', outputFormat);
//     formData.append('maxFileSize', MAX_FILE_SIZE_BYTES.toString()); // Pass max file size for server-side validation

//     try {
//       // Corrected API endpoint to /api/image-converter
//       const response = await fetch('/api/convert/convert-image', {
//         method: 'POST',
//         body: formData,
//       });
...
//       // Expecting a JSON response containing an array of converted images
//       const result = await response.json();
//       const newConvertedImages = result.convertedImages.map(img => ({
//         id: img.fileName + Date.now() + Math.random(), // Ensure unique ID
//         name: img.fileName,
...
// document-pro/src/app/tools/image-converter/page.jsx
// 'use client';
...
//     });
//     formData.append('format', outputFormat);
//     formData.append('maxFileSize', MAX_FILE_SIZE_BYTES.toString());
...
//       // --- Dispatch custom event to update tokens in Navbar ---
...
// document-pro/src/app/image-converter/page.jsx
'use client';
